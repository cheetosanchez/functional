...
from sum_types_p import CSVExportStatus, CSVStatusResult, get_csv_status

TestCase = tuple[Any, Any, CSVStatusResult]
...
def test(status: Any, data: Any, expected: CSVStatusResult) -> bool:
    print("---------------------------------")
